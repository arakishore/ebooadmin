    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <span class="breadcrumb-item active">Add Amenity Type</span>
            </div>
...
<div class="content">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('amenity_types/store') ?>" method="POST">
                <?= csrf_field() ?>

                <div class="form-group mb-3">
                    <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control <?= session('errors.name') ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= old('name') ?>" placeholder="e.g., Free WiFi" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter amenity description"><?= old('description') ?></textarea>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="icon" name="icon" value="<?= old('icon') ?>" placeholder="e.g., icon-wifi">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="sort_order" class="form-label">Sort Order</label>
                            <input type="number" class="form-control <?= session('errors.sort_order') ? 'is-invalid' : '' ?>" id="sort_order" name="sort_order" value="<?= old('sort_order', 0) ?>" placeholder="0">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success">
                        <i class="icon-check"></i> Create Amenity Type
                    </button>

    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <span class="breadcrumb-item active">Add Package Fact Type</span>
            </div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title"> Add Package Fact Type </h6>
        </div>
        <div class="card-body">
            ...
            <form action="<?= base_url('package_fact_types/store') ?>" method="POST">
                <?= csrf_field() ?>

                <div class="form-group mb-3">
                    <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control <?= session('errors.name') ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= old('name') ?>" placeholder="e.g., Fact Name" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter package fact type description"><?= old('description') ?></textarea>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success">
                        <i class="icon-check"></i> Create Package Fact Type
                    </button>

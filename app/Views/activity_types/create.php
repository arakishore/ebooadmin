    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <span class="breadcrumb-item active">Add Activity Type</span>
            </div>
...
<div class="content">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('activity_types/store') ?>" method="POST">
                <?= csrf_field() ?>

                <div class="form-group mb-3">
                    <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control <?= session('errors.name') ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= old('name') ?>" placeholder="e.g., Adventure" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="icon" name="icon" value="<?= old('icon') ?>" placeholder="e.g., icon-skiing">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success">
                        <i class="icon-check"></i> Create Activity Type
                    </button>

    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <span class="breadcrumb-item active">Create FAQ</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('faqs/store') ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="question" value="<?= esc(old('question')) ?>" class="form-control" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Answer</label>
                    <textarea name="answer" rows="6" class="form-control" required><?= esc(old('answer')) ?></textarea>
                </div>
